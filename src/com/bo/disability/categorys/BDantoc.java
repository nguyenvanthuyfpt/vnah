...
public class BDantoc {

    public FDantoc getRecordByID(FSeed seed) throws EException, SQLException {
    ...
    public Map<String, String> get_map_dantoc() throws Exception {
        ...
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            String sql = "select dantoc_id,name from dr_dantoc";
