...
public class BDangTat {

    public FDangTat getRecordByID(FSeed seed) throws EException, SQLException {
        final String LOCATION = this + "->getRecordByID()";
        FDangTat result = null;
        Connection conn = null;
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            DBConnector.startTransaction(conn);
            DDangTat dao = new DDangTat();
    ...
    public Map<String,String> get_map_dangtat() throws Exception{
        ...
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            String sql = "select dangtat_id,name from dr_classification";
