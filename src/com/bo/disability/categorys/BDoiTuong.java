...
import com.dao.disability.categorys.DDoiTuong;
...
public class BDoiTuong {

    public FDoiTuong getRecordByID(FSeed seed) throws EException, SQLException {
        final String LOCATION = this + "->getRecordByID()";
        FDoiTuong result = null;
        Connection conn = null;
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            DBConnector.startTransaction(conn);
            DDoiTuong dao = new DDoiTuong();
    ...
    public Map<String, String> get_map_doituong() throws Exception {
