...
import com.dao.disability.categorys.DNguonhotro;
...
public class BNguonhotro {

    public FNguonhotro getRecordByID(FSeed seed) throws EException, SQLException {
        final String LOCATION = this + "->getRecordByID()";
        FNguonhotro result = null;
        Connection conn = null;
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            DBConnector.startTransaction(conn);
            DNguonhotro dao = new DNguonhotro();
    ...
    public Map<String,String> get_map_nguonhotro() throws Exception{
        ...
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            String sql = "select nguonhotro_id,name from dr_nguonhotro";
