...
import com.dao.disability.DIndicatorVal;
...
public class BIndicatorVal {
    DIndicatorVal dao = new DIndicatorVal();
    ...
    public boolean update(FSeed seed) throws EException, SQLException {
     ...
     public FBeans getIndicatorValues(FSeed seed) throws EException {
    ...
    public FIndicatorVal getDetailByID(FSeed seed) throws EException, SQLException {
        final String LOCATION = this + "->getRecordByID()";
        FIndicatorVal result = null;
        Connection conn = null;
        try {
            conn = DBConnector.getConnection(AppConfigs.ADMIN_CONNECTION_ID);
            DBConnector.startTransaction(conn);
