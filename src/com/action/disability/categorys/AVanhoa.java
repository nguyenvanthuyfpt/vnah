...
import com.form.disability.categorys.FVanhoa;
...
public class AVanhoa extends ACore {
    ...
    private String validate(FVanhoa bean, String anchor, ActionErrors errors) {
