...
public class AAgenda extends  ACore {
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws EException,IOException, ServletException,SQLException
    {
        ...
        bean.setYear(bean.getYear()==0?bean.getYear(bean.getCurrentSqlDate()):bean.getYear());
            ...
            if(!errors.isEmpty()){
                ...
                request.setAttribute("BEvents",bo.getEventsByMonth(bean.getUserId(),dayStart,bean.getDays(dayStart,dayEnd)+1,bean.getType(),me.getDepartmentID()));
                ...
                request.setAttribute("BEvents",bo.getEventsTest(bean.getUserId(),dayStart,7,bean.getType(),me.getDepartmentID()));
                ...
                request.setAttribute("BEvents",bo.getEventsTest((int)bean.me.getId(),dayStart,7,bean.getType(),me.getDepartmentID()));
                ...
                if(bean.getId()>0){
                    bean=new BCalendar().getById(bean.getId());
                    bean.setType(type);
            ...
            request.setAttribute("BEventTimes",new BCalendar().getEventsTest(bean.getUserId(),bean.stringToSqlDate(bean.getTimeEvent()),1,bean.getType(),me.getDepartmentID()));
            target=anchor;
       }
