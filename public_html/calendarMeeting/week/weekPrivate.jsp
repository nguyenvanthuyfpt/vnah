...
<tr >
<bean:define name="agendaMeeting"  id="beanT" type="com.form.calendarMeeting.agenda.FAgendaMeeting" />
            <td>
                <%
            ...
            <td >
               <logic:iterate name="bean" property="eventsInDay" id="beanInDay" type="com.form.calendarMeeting.agenda.FAgendaMeeting">
               ...
               phut+=(time2-time1)*60;
               %>
               <logic:equal name="beanInDay" property="baseEmp" value="" >    
               <div class="<%=className%>"  onclick="prepareCalendar('<%=beanInDay.getTimes()%>','<%=beanInDay.getTimeEvent()%>',0)" >
               
               </div>
               </logic:equal>
               <logic:notEqual name="beanInDay" property="baseEmp" value="" >    
               ...
               <div class="<%=className%>" >
                   ...
                   <bean:write name="beanInDay" property="baseEmp" />
                   </div>
               </div>
...
<html:hidden name="agendaMeeting" property="id_week" />
<div id="combobox"></div>
