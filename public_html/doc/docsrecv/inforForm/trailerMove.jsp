                        ...
                        <li > <strong><bean:write name="bean" property="nameStatus" /> : </strong> <bean:write name="bean" property="timeSend" /></li>
                         <li >
                          ...
                          <bean:message key="messages.list.empSend" bundle="<%=interfaces%>"/> : <bean:write name="bean" property="sendUserName" /> 
                           ...
                           [ <a href="#" onmouseover="javascript:addthis_open(this,'N&#7897;i dung &#7911;y quy&#7873;n','','', '');postAjax('docsrecv','at_share',anchor + ':_TIP_FORYOU:forYouId:<bean:write name="bean" property="forYouId"/>');" onmouseout="addthis_close()" ><bean:message key="form.docs.forYouId" bundle="<%=interfaces%>"/></a> ]
                            </logic:notEqual>
                          </logic:notEqual>
