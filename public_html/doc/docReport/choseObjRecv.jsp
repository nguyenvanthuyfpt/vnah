...
<%@ include file="/commons/params.jsp" %>
		...
		<td  align="left">
                ...
                <td  align="left">
                 ...
                 <bean:message key="form.docs.fromId2" bundle="<%=interfaces%>"/> 
	...
	<tr>
		  <td  align="left">
                ...
                <td  align="left">
                <input type="checkbox" name="fields" value="10" checked>
	...
	<tr>
                ...
                <bean:message key="form.docs.viaId" bundle="<%=interfaces%>"/>
                    ...
                    <bean:message key="form.docs.kyNhan" bundle="<%=interfaces%>"/>
                    </td>
