...
<bean:message key="categoryvia.via" bundle="<%=interfaces%>"/></b></font></p>
<logic:notPresent parameter="oberver">
<logic:present name="BTransfer">
<bean:define name="BTransfer" id="beansT" type="com.form.FBeans"/>
    <%if(beansT.size()>1){%>
        <html:select name="docssend" property="views" onchange="javascript:post('docssend',anchor+':_VIEW');" styleClass="fieldSelect" style="width:100px;" >
