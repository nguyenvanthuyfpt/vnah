               ...
               <div class="content-calendar"> 
                <table width="100%" border="0px" cellpadding="0" cellspacing="0">  
                    ...
                    <TR>
                        ...
                        <table  class="tableForm" align="center" cellpadding="0" style="border-collapse: collapse" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td  nowrap><bean:message key="form.docs.abstracts" bundle="<%=interfaces%>"/><bean:message key="alert.type.information" bundle="<%=interfaces%>"/></td>
                                                    <td  colspan="3" >
                                                     <html:textarea name="docssend" property="abstracts" styleId="abstracts"  style="width:420px;height:60px;" />
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                            ...
                                                            <div style="padding-left:10px;"><a href="javascript:hideshow('detail');"><bean:message key="form.docs.detail" bundle="<%=interfaces%>"/>...</a></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="3" >                
                                                        <html:textarea name="docssend" property="title" styleId="title"  style="width:420px;height:60px;" />
                                                    </td>
                                                </tr>
                                                </logic:equal>
                                                <tr>
