            ...
            <div class="csstable"><table cellpadding="0" cellspacing="0" border="0">
                <tr><td width="8"><img src="<%=contextPath%>/images/newImages/i_47.gif" /></td>
                    <td bgcolor="#a0aec2" style="padding:0 7px"><span class="add">
                      <a class="modal-button" href="from<%=extention%>?<%=anchor%>=_PREPARED_CREATE" rel="{handler: 'iframe', size: {x:365, y: 240}}"><img src="<%=contextPath%>/images/newImages/i_16.gif" align="left" /><b><bean:message key="privilege.insert" bundle="<%=interfaces%>"/></b></a>
                    </span></td>
