...
function showTT(){
    post('agenda',anchor + ':_CALENDAR_WEEK');
}
</script>
...
<tr>
                ...
                <a href="javascript:post('agenda',anchor + ':_WEEK_CURENT');"><bean:message key="agenda.label.today" bundle="<%=interfaces%>"/>,<bean:message key="agenda.form.edit.timeEvent" bundle="<%=interfaces%>"/> <%=beanDate.getDate(beanDate.getCurrentSqlDate())%>  <bean:message key="agenda.label.month" bundle="<%=interfaces%>"/> <%=beanDate.getMonth(beanDate.getCurrentSqlDate())%> <bean:message key="agenda.label.year" bundle="<%=interfaces%>"/> <%=beanDate.getYear(beanDate.getCurrentSqlDate())%></a>
                </div>
                </td>
                <td align="right">
...
<tr>
<td width="5%" align="center"><img style="cursor: pointer" width="15px" src="<%=contextPath%>/images/record-prev.png" onclick="javascript:post('agenda',anchor + ':_PREW_WEEK');" /></td>
...
<td width="5%" align="right"><img style="cursor: pointer" width="15px" src="<%=contextPath%>/images/record-next.png" onclick="javascript:post('agenda',anchor + ':_NEXT_WEEK');" /></td>
</tr>
</table>
                </td>
</tr>
...
<div>
    <jsp:include page="/calendar/week/weekPrivate.jsp" />
</div>
