...
<html:form action="searchdispeople" method="post" onsubmit="javascript:getQuanLyCaResult();return false;">

<div  id="divSearchResult" style="display:none"></div>	
<div  id="divSearchForm">	
    <ul id="tree">
        <li>
            <div class="bgr4"><a href="javascript:excutePostCategorys('_QUANLYCA')">Qu&#7843;n l&#253; ca</a></div>
        </li>
    </ul>	
    <br/>
    ...
    <tr>
    	<td colspan="2">
            <img src="images/front/imgTop_ctn.gif" width="686" height="4" /></td></tr>
    <tr>
    	<td style="border-right:1px solid #e2e2e2; border-left:1px solid #e2e2e2;" colspan="2">
            <div style="padding:20px 15px 0 15px">
                ...
                <tr>
                    ...
                    <td>
                        <html:select styleClass="inputbox" name="timkiem" property="kyBC" onchange="changeKyBC(this.value);">
                            <html:option value="-1">T&#7845;t c&#7843;</html:option>
                            <html:option value="0">N&#259;m</html:option>
                            <html:option value="1">Th&#225;ng 1</html:option>
                            <html:option value="2">Th&#225;ng 2</html:option>
                            <html:option value="3">Th&#225;ng 3</html:option>
                            <html:option value="4">Th&#225;ng 4</html:option>
                            <html:option value="5">Th&#225;ng 5</html:option>
                            <html:option value="6">Th&#225;ng 6</html:option>
                            <html:option value="7">Th&#225;ng 7</html:option>
                            <html:option value="8">Th&#225;ng 8</html:option>
                            <html:option value="9">Th&#225;ng 9</html:option>
                            <html:option value="10">Th&#225;ng 10</html:option>
                            <html:option value="11">Th&#225;ng 11</html:option>
                            <html:option value="12">Th&#225;ng 12</html:option>                            
                        </html:select>
                    </td>
                    <td colspan="2" id="yearBC">
                        <table width="100%">
                        <tr>
                            <td nowrap="nowrap">N&#259;m:</td>
                            <td>
                                <html:text name="timkiem" property="namBC" onblur="isYear(this);" style="width:70px" />
                            </td>
                        </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td  nowrap="nowrap"><bean:message key="disability.form.label.tinhId" bundle="<%=interfaces%>"/> :</td>
	    ...
	    <tr>
	    	...
	    	<td>
             ...
             <tr>
                <html:hidden name="timkiem" property="quanLyCa" />
