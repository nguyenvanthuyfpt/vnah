    ...
    <table id="toolbar" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr valign="center" align="middle">
            <td>
                ...
                <html:button property="_EDIT" styleClass="button" onclick="post('kpi_rank',anchor + ':_CREATE');">
            ...
            <logic:greaterThan name="rank" property="id" value="0">
                <td>&nbsp;</td>
                <td>
                              <span class="bt_left_Search">
                  <span class="bt_right_Search">
                    ...
                    <html:button property="_EDIT" styleClass="button" onclick="post('kpi_rank',anchor + ':_EDIT');">
                ...
                <td>
                  ...
                  <span class="bt_right_Search">
                    ...
                    <html:button property="_EDIT" styleClass="button" onclick="post('kpi_rank',anchor + ':_DELETE');">
