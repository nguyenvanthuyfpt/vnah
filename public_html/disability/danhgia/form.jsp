...
<div>
	<table class="tableRank" cellpadding="2" width="100%" align="center" style="border-clilapse: clilapse" cellspacing="2" border="0">    
	<tr>
		<td width="15%">
			Ng&#224;y &#273;&#225;nh gi&#225;
		</td>
		<td>
			<html:text name="danhgiaht" property="dateCreate" onkeypress="return formatDate(event,this);" onblur="isDate(this);" styleId="dateCreate" style="width:80px" />
	...
	<tr>
		...
		<td>
			...
			N&#259;m &#273;&#225;nh gi&#225;:
			<html:text name="danhgiaht" property="namDanhGia" onblur="isYear(this);" style="width:50px" onkeydown="if(event.keyCode==13){postAjax('danhgia_nkt','idrank',anchor + ':_LIST');return false;}" />
		</td>
	</tr>
	</table>
</div>
	...
	<tr>
		<td>	
			<logic:notEqual name="danhgiaht" property="idNkt" value="0">
				<html:button property="_CREATE" styleClass="button" onclick="postAjax('danhgia_nkt','idrank',anchor + ':_CREATE');" >
	    ...
	    <tr class="<%=(i%2==0)?"content1":"content"%>">
		    ...
		    <td  nowrap width="50px">
				...
				<img style="cursor:pointer;" src="<%=contextPath%>/images/delete.png" 
					...
					onClick="javascript:if(messageDelete())postAjax('danhgia_nkt','idrank',anchor + ':_DELETE:id:<%=bean.getId()%>')">                        
		    </td>
	    </tr>
	</logic:iterate>
</logic:present>
