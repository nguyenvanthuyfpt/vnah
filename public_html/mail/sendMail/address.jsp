...
<style type="text/css">
	...
	form{
        ...
        <html:text name="sendMail" property="cc" styleId="cc" onclick="getObj('tem').value=1" onkeyup="searchEmail(this,'2','formMyContact','Anchor=_SEARCH_PAGE',event,'doc_from')" style="width:95%" />
