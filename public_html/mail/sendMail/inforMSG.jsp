            ...
            <div id="fragment-1">
               <div class="content-calendar" id="MainDirectory">      
                    ...
                    <tr>
                        ...
                        <%String cmdcoplete="postAjax('sendMail','right',anchor + ':_INBOX_AJAX:folderName:"+ com.inf.mail.IKeyMail.FOLDER_INBOX +"')";%>
                                <html:button property="_INBOX_AJAX" onclick="<%=cmdcoplete%>" styleClass="button">
