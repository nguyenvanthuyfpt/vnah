             ...
             <table cellpadding="0" cellspacing="0" border="0">
                <tr><td width="8"><img src="<%=contextPath%>/images/newImages/i_47.gif" /></td>
                    <td bgcolor="#a0aec2" style="padding:0 7px"><span class="add">
                            <a href="javascript:post('registerMail',anchor +':_PREPARED_CREATE');"><img src="<%=contextPath%>/images/newImages/i_16.gif" align="left" /><Strong><bean:message key="category.mailAccount.register" bundle="<%=interfaces%>"/></strong></a>
                    </span></td>
                ...
                <div class="status" id="idEdit">
                    <jsp:include page="/mail/register/edit.jsp" />
                </div>
