...
<td bgcolor="#F0F5E5" valign="top" align="center" style="cursor: move;"  onmousedown="makeObjectToDrag('winPopup')"> 
  ...
  <tr>
       ...
       <html:form action="forYouRulesOpen" method="POST">
    ...
    <html:hidden name="forYouRulesOpen" property="index"/>
    <tr >
        <td class="" height="26px"><bean:message key="problem.dep.caption" bundle="<%=interfaces%>"/></td>
        <td >
            <html:select styleClass="inputbox"  name="forYouRulesOpen" property="departmentID" onchange="javascript:postAjax('forYouRulesOpen','ruleUsers',anchor+':_SHOW:departmentID:'+ this.value);"> 
            ...
            <bean:define name="forYouRulesOpen" property="index" id="index" type="java.lang.Integer"/>          
