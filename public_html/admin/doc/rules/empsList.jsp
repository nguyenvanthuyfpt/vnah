...
<div align="left">
         <select multiple="multiple" style="width:250px;height:200px" ondblclick="javascript:if(this.form.radioEmp[0].checked){AddUser(this.form.docBoss,this)}else{AddUser(this.form.docofficer,this);};">
