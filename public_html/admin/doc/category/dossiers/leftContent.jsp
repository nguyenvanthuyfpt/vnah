    ...
    <div class="ctn-left">
        ...
        <div class="csstable"><table cellpadding="0" cellspacing="0" border="0">
            <tr><td width="8"><img src="<%=contextPath%>/images/newImages/i_47.gif" /></td>
                ...
                <a class="modal-button"  href="dossiers<%=extention%>?<%=anchor%>=_PREPARED_CREATE" rel="{handler: 'iframe', size: {x:350, y:220}}"><img src="<%=contextPath%>/images/newImages/i_16.gif" align="left" /><b><bean:message key="privilege.insert" bundle="<%=interfaces%>"/></b></a>
                </span></td>
        ...
        <p><input class="InputSearch" id="contentSearch" name="contentSearch"  onkeydown="if(event.keyCode==13){post('dossiers',anchor + ':_SEARCH');messageImg('right');return false;}"  onFocus="this.value=''" type="text" maxlength="200" >
        </div>
