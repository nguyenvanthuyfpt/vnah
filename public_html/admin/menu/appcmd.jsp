...
<TR vAlign=center align=middle>
    <TD><A class=toolbar href="javascript:post('apps',anchor + ':_CREATE');"><IMG 
  ...
  <logic:greaterThan name="BApp" property="id" value="0">
      <TD>&nbsp;</TD>
      <TD><A class=toolbar href="javascript:post('apps',anchor + ':_EDIT');"><IMG 
      ...
      <TD>&nbsp;</TD>
      <TD><A class=toolbar href="javascript:post('apps',anchor + ':_DELETE');"><IMG 
