...
<logic:present name="ADMIN.PANEL.ROLE">
	...
	<TBODY>
		...
		<TR>
			<TD> <jsp:include page="/admin/role/role.jsp" /></TD></TR>
	</TBODY>
	</TABLE>
</logic:present>
...
<logic:present name="ADMIN.PANEL.PRIVILEGE">
	...
	<TR>
		<TD> <jsp:include page="/admin/apps/app.jsp" /></TD></TR>
	</TBODY>
	</TABLE>
</logic:present>
...
<TR>
	<TD id="menu_option"><jsp:include page="/admin/role/menuTree.jsp" /> </TD></TR>
</TBODY>  
</TABLE>
