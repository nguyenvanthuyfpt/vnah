...
<td bgcolor="#F0F5E5" valign="top" align="center" style="cursor: move;"  onmousedown="makeObjectToDrag('winPopup')"> 
  ...
  <tr>
       ...
       <html:form action="templateRuleOpen" method="POST">
    ...
    <html:hidden name="templateRuleOpen" property="index"/>
    <tr >
        <td class="" height="26px"><bean:message key="problem.dep.caption" bundle="<%=interfaces%>"/></td>
        <td >
            <html:select styleClass="inputbox"  name="templateRuleOpen" property="departmentID" onchange="javascript:postAjax('templateRuleOpen','ruleUsers',anchor+':_SHOW:departmentID:'+ this.value);"> 
            ...
            <bean:define name="templateRuleOpen" property="index" id="index" type="java.lang.Integer"/>          
            <bean:message key="rules.assignEmp.caption" bundle="<%=interfaces%>"/> <input type="radio"  name="radioEmp" id="radioEmp" value="0" <%=index.intValue()==0?"checked":""%>/>
