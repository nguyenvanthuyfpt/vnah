    ...
    <div class="box-outer">
      <div class="box-inner">
        <div class="box-top">
          ...
          <logic:iterate name="BTotals" id="bean" indexId="i" type="com.form.admin.servey.FServey">
                ...
                <div class="answer">
                  <ul class="wp-polls-ul">
                    <logic:notEmpty name="bean" property="questions">
                        <logic:iterate name="bean" property="questions" id="beanQuestions" type="com.form.admin.servey.FServeyQuestions">                       
