...
<td bgcolor="#F0F5E5" valign="top" align="center" style="cursor: move;"  onmousedown="makeObjectToDrag('winPopup')"> 
  ...
  <tr>
       ...
       <html:form action="reportRuleOpen" method="POST">
    ...
    <html:hidden name="reportRuleOpen" property="index"/>
    <tr >
        <td class="" height="26px"><bean:message key="problem.dep.caption" bundle="<%=interfaces%>"/></td>
        <td >
            <html:select styleClass="inputbox"  name="reportRuleOpen" property="departmentID" onchange="javascript:postAjax('reportRuleOpen','ruleUsers',anchor+':_SHOW:departmentID:'+ this.value);"> 
            ...
            <bean:define name="reportRuleOpen" property="index" id="index" type="java.lang.Integer"/>          
