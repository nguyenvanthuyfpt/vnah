...
<script language="javascript" src="<%=contextPath%>/js/mootools-trunk.js"></script>
 <script language="javascript" src="<%=contextPath%>/js/SqueezeBox.js"></script><script language="javascript" src="<%=contextPath%>/js/action.js"></script>
...
<script language="javascript" src="<%=contextPath%>/js/index.js"></script>
