...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="tblmenu">
                <tr><td width="2%"><img src="<%=contextPath%>/images/newImages/i_01.gif" /></td>
	                <td><table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr><td width="10%"><a href="javascript:post('disabilityFuntion',anchor + ':_SEARCH')"><Strong><bean:message key="menu.top.home" bundle="<%=interfaces%>"/></strong></a></td>
                                <td><table cellpadding="0" cellspacing="0" border="0" class="group5">
                            		    <tr><td width="8px"><img src="<%=contextPath%>/images/newImages/i_04.gif"/></td>
                                                ...
                                                <html:select  name="change" property="app" onchange="javascript:eval(this.value)"  styleClass="fieldSelect" style="width:90px;"> 
                                                            ...
                                                            <logic:equal name="<%=com.lib.AppConfigs.CHECK_CREATOR_DOCSSEND_DT%>" value="1">
                                                            ...
                                                            <% if(request.getSession().getAttribute("04")!=null && request.getSession().getAttribute("04.02")!=null){%>
                                                                <html:option value="post('change',anchor + ':_CABIN:type:0:cabinType_id:0')"><bean:message key="title.template.label.cabin" bundle="<%=interfaces%>"/></html:option>
                                                            <%}%>
                                                           ...
                                                           <html:option value="post('disabilityFuntion',anchor + ':_SEARCH')"><bean:message key="menu.disability.create" bundle="<%=interfaces%>"/></html:option>
                                                           <%}%>
                                                </html:select>
                                    ...
                                    <td width="35%" align="right"><a href="#"><%=me.getFullName()%></a>
                                    <span>|</span>
                                        <a class="modal-button" href="login<%=extention%>?<%=anchor%>=_PREPARED_EDIT" rel="{handler: 'iframe', size: {x:250, y: 180}}">
                                          <bean:message key="login.change.password" bundle="<%=interfaces%>"/></a>
                                    <span>|</span>
                                        <!--<a href="javascript:post('change',anchor + ':_HELP')">-->
                                        <a href="hepl/UserGuide_v1.0.doc">
                                          <bean:message key="app.help" bundle="<%=interfaces%>"/></a>
                                    <span>|</span>
                                        <a href="javascript:post('login',anchor + ':_LOGOUT');"><bean:message key="logout.caption" bundle="<%=interfaces%>"/></a></td>
                                </tr>
                            </table>
                        </td>
