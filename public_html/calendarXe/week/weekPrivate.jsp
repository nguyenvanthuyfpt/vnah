...
<tr >
<bean:define name="agendaXe"  id="beanT" type="com.form.calendarXe.FCalendarXe" />
            <td>
                <%
            ...
            <td >
               <logic:iterate name="bean" property="eventsInDay" id="beanInDay" type="com.form.calendarXe.FCalendarXe">
...
<html:hidden name="agendaXe" property="id_week" />
<div id="combobox"></div>
