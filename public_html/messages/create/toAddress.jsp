...
<style type="text/css">
	...
	form{
        ...
        <html:text name="createMessage" property="toAddress" styleId="toAddress" onkeyup="searchEmail(this,'2','createMessage','Anchor=_SEARCH_PAGE',event,'doc_from')" style="width:250px" />
