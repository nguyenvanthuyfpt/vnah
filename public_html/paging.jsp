...
%>
<TABLE style="table-layout:fixed;border:0px" align="right">
  <TBODY>
  <TR>
    ...
    <TH style="padding-top:0px;width:80px;font-family:Tahoma;font-size:11px;font-weight: normal;" nowrap>
            <bean:message key="page.caption" bundle="<%=interfaces%>"/>
            <input onkeydown="if(event.keyCode==13){<%=METHOD%>('<%=FORM%>'<%=POSITION%>,'<%=PARAMS%>pageIndex:' + this.value);return false;}" type="text" name="selectPage" value="<%=pageCurrent%>" style="font-family:Tahoma;font-size:11px;text-align: right;">
